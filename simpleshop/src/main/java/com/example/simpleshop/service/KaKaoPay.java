...
import com.example.simpleshop.domain.KakaoPayApprovalV0;
import com.example.simpleshop.domain.KakaoPayReadyVO;
...
public class KaKaoPay {
    ...
    public String kakaoPayReady() {
        ...
        headers.add("Authorization", "KakaoAK " + "admin 코드를 넣어주세요");
